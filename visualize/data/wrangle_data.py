...
def return_articles():
    return pd.read_sql("SELECT ID, DOI, Type, Source, title_words, abstract_length, "
                       "abstract_wc, abstract_kw, abstract_kw_sum  "
                       "FROM articles ORDER BY abstract_kw_sum DESC LIMIT 20",
